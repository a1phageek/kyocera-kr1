 ...
 *
 * $Id: uemf.h,v 1.2 2004/06/14 13:48:17 rupert Exp $
 */
...
/******************************* Per O/S Includes *****************************/
	...
	#include	<network.h>
	#include	<errno.h>
	#include	<arpa/inet.h>		// jimmylin
	#include	<stdlib.h>			// jimmylin
	#include	<unistd.h>			// jimmylin
	#define		NFDBITS	__NFDBITS	// jimmylin
#endif /* ECOS */
...
#if FIXMEM
#define MEM_START	0x80030000
#define B_DEFAULT_MEM	0x80080000-MEM_START//(400 * 1024)			/* Default memory allocation */
#else
#define B_DEFAULT_MEM	64*1024//(400 * 1024)			/* Default memory allocation */
#endif
#define B_MAX_FILES		(64)				/* Maximum number of files */
