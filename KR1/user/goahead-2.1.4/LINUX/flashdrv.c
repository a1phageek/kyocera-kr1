	...
	for( flashSeq = 0; flashSeq < MAX_FLASH_CHIPS; flashSeq++ )
	{
		...
		switch ( devId )
		{
	        ...
	        case MX29LV640BT_DEVID:
	        	...
	        	flash_chip_info[flashSeq].BoardInfo   = 0x007FE000; // for resize & relocate BDINFO in flash 
	        	flash_chip_info[flashSeq].CGIConfig   = 0x007F0000; // for resize & relocate CFG in flash 
	        	flash_chip_info[flashSeq].RuntimeCode = 0x00020000;
	        	break;
