...
#ifndef CRONTABS
#define CRONTABS        "/var/ppp"
#endif
#ifndef TMPDIR
#define TMPDIR          "/var/ppp"
#endif
#ifndef SENDMAIL
...
static const char def_sh[] = "/bin/ash";
	...
	const char *prog, const char *cmd, const char *arg, const char *mailf)
{
    ...
    pid_t pid = fork();
#ifdef Peter
    crondlog("crond[crond.c] ForkJob : %d", pid);
#endif
...
#ifdef Peter
	crondlog("crond[crond.c] ForkJob : before execl\n");
#endif	
