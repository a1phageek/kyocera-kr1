 ...
 * for more details.
 *
 * RCSID $Id: demux.c,v 1.1 2004/12/24 07:17:32 rupert Exp $
 */
...
#define SEND_NOTIFICATION(t) { \
	...
	if (st == NULL)
	{
	     ...
	     * new message in an oustanding XAUTH server conservation
...
complete_state_transition(struct msg_digest **mdp, stf_status result)
{
	...
	case STF_OK:
	    ...
	    if(st->st_connection->spd.that.modecfg_server
		   && IS_ISAKMP_SA_ESTABLISHED(st->st_state)
