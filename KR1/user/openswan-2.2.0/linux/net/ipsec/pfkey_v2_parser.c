 ...
 * for more details.
 *
 * RCSID $Id: pfkey_v2_parser.c,v 1.1 2004/12/24 07:17:31 rupert Exp $
 */
...
char pfkey_v2_parser_c_version[] = "$Id: pfkey_v2_parser.c,v 1.1 2004/12/24 07:17:31 rupert Exp $";
