...
#
# 
# $Id: uml-functions.sh,v 1.1 2004/12/24 07:17:41 rupert Exp $
#
...
setup_make() {
    ...
    echo "$TAB make -C ${OPENSWANSRCDIR} OPENSWANSRCDIR=${OPENSWANSRCDIR} MODBUILDDIR=$POOLSPACE/module KERNELSRC=$POOLSPACE/plain ARCH=um SUBARCH=${SUBARCH} module "
    echo
}
