...
# * All rights reserved.                                                    
# * 
# * $Header: /home/cvsroot/uClinux-dist/loader_srcroot/src/rtl8650/initmem.s,v 1.20 2004/08/13 01:32:47 yjlou Exp $
# *
# * $Author: yjlou $
# *
# * Abstract:
...
1:
	...
	#--- configure MCR
        #li		$4,0xfaa00000		# default 32-bit, 32MB SDRAM, 2MB FLASH, 200MHz
        #li		$4,0xFAA02000		# QA board with 8MB flash & 32MB SDRAM 16-Bit 
	#li		$4,0xDAB02000		# 32-bit 8MB SDRAM & 8MB flash     (ALi 1st GST board)
	#li		$4,0xFAA02000		# 16-bit 32MB      & 8MB flash     (ALi 2nd GST board)
	#li		$4,0xFAB02000		# 32-bit 32MB x 2  & 8MB flash     (ALi 2nd GST board)
	#li		$4,0xFAB03000		# 32-bit 32MB x 2  & 16MB Intel J3 (Nec 3rd GST board)
	#li		$4,0xEAA01000		# 16-bit 16MB      & 4MB  Intel C3 (ALi 2nd GST board)
	#li		$4,0xDAB01000		# 32-bit  8MB x 2  & 4MB  Intel J3 (NEC 3nd GST board)
	#li		$4,0xEAB01000		# 32-bit 16MB x 2  & 4MB  Intel J3 (NEC 3nd GST board)	
	...
	#li		$4,0x1b1b1b00		# Flash timing, faster but not stable
	#li		$4,0x2F2F2F00		# Flash timing
	li		$4,0x2F2F2F00		# Flash timing
	li		$5,0xBD013004
	sw		$4,0($5)

	#li		$4,0x00000CEA		# SDRAM timing, faster
	#li		$4,0x000019EC		# SDRAM timing
	li		$4,0x00000CEA		# SDRAM timing	
	li		$5,0xBD013008
	sw		$4,0($5)
