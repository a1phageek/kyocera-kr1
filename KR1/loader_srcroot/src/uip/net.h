...
#define MAXPACKETLEN 600 //Remove by Steven to support TCP Stack
//#define MAXPACKETLEN (1540-14) //Add by Steven to support TCP Stack
...
//	unsigned short src_port;
//	unsigned short dst_port;
//	unsigned int seqnum __attribute__ ((packed));
//	unsigned int acknum __attribute__ ((packed));
//	unsigned short hrf;
