 ...
 * for more details.
 *
 * RCSID $Id: constants.h,v 1.1 2003/10/15 06:52:30 hiwu Exp $
 */
...
#ifdef NAT_TRAVERSAL
#define ISAKMP_NEXT_NATD_R     14   /* NAT-Traversal: NAT-D (Relocated) */
#define ISAKMP_NEXT_NATOA_R    15   /* NAT-Traversal: NAT-OA (Relocated) */
#define ISAKMP_NEXT_ROOF       16	/* roof on payload types */
#define ISAKMP_NEXT_NATD       130  /* NAT-Traversal: NAT-D */
#define ISAKMP_NEXT_NATOA      131  /* NAT-Traversal: NAT-OA */
#else
...
#ifdef NAT_TRAVERSAL
#define ENCAPSULATION_MODE_UDP_TUNNEL     61443
#define ENCAPSULATION_MODE_UDP_TRANSPORT  61444
#endif
...
/* Vendor IDs */
extern const char dpd_vid[];	/* Dead Peer Detection */
extern const int dpd_vid_length;
