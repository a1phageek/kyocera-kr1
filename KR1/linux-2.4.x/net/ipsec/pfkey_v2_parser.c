 ...
 * for more details.
 *
 * RCSID $Id: pfkey_v2_parser.c,v 1.7 2005/02/22 09:31:38 yjlou Exp $
 */
...
char pfkey_v2_parser_c_version[] = "$Id: pfkey_v2_parser.c,v 1.7 2005/02/22 09:31:38 yjlou Exp $";
	...
	if ((ixt_e=ipsp->ips_alg_enc)) 
	{
		...
		printk("AES encryption\n\n");
			if ((retval=rtl8651_addIpsecSpi(((struct sockaddr_in*)ipsp->ips_addr_d)->sin_addr.s_addr,
                            ...
                            0x7/*IPSEC_CBC_AES256*/, (char*)ipsp->ips_key_e,
				4,ipsp->ips_key_a,
				0,60,64, 1)))
			{
				printk(" %d rtl8651_addIpsecSpi FAILED %d\n",__LINE__,retval);
			}
 ...
 * Revision 1.7  2005/02/22 09:31:38  yjlou
 * +: support AES256 for OpenSWAN.
 * *: fixed the bug of SPI initial sequence number.
 * *: little improvement for IV.
 *
 * Revision 1.6  2005/02/22 01:58:10  rupert
