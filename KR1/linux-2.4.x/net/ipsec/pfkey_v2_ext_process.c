 ...
 * for more details.
 *
 * RCSID $Id: pfkey_v2_ext_process.c,v 1.2 2005/02/22 01:58:10 rupert Exp $
 */
...
char pfkey_v2_ext_process_c_version[] = "$Id: pfkey_v2_ext_process.c,v 1.2 2005/02/22 01:58:10 rupert Exp $";
