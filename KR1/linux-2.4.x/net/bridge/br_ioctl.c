 ...
 *
 *	$Id: br_ioctl.c,v 1.3 2004/10/29 09:32:27 cfliu Exp $
 *
			   ...
			   unsigned long arg2)
{
	...
	case BRCTL_SET_BRIDGE_STP_STATE:
		...
		{
			int retval=0;
			retval=rtl8651_setSpanningTreeInstanceProtocolWorking(0, arg0? 1:0);
			if(0==retval)
				printk("RTL865x VLAN STP %s\n", arg0?"enabled":"disabled");
			else
				printk("RTL865x VLAN STP set %s error=%d", arg0?"enabled":"disabled", retval);
		}
#endif
