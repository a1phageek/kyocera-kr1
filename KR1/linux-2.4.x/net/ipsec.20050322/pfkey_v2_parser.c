 ...
 * for more details.
 *
 * RCSID $Id: pfkey_v2_parser.c,v 1.1 2004/08/02 02:09:59 rupert Exp $
 */
...
char pfkey_v2_parser_c_version[] = "$Id: pfkey_v2_parser.c,v 1.1 2004/08/02 02:09:59 rupert Exp $";
