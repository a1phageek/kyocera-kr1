 ...
 * for more details.
 *
 * RCSID $Id: pfkey_v2_ext_process.c,v 1.1 2004/08/02 02:09:59 rupert Exp $
 */
...
char pfkey_v2_ext_process_c_version[] = "$Id: pfkey_v2_ext_process.c,v 1.1 2004/08/02 02:09:59 rupert Exp $";
