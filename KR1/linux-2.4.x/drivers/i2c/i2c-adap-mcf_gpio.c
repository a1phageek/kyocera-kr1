 ...
 *
 * Copyright (C) 2003, 2004 Videon Central, Inc.
 *
 * ----------------------------------------------------------------------------
...
/* $Id: i2c-adap-mcf_gpio.c,v 1.1 2004/05/31 02:32:34 rupert Exp $ */
...
{
        printk(KERN_INFO "%s: Motorola Coldfire GPIO I2C adapter\n", __FILE__);
