...
// for verify Cardbus USB v1.1 throughput
int myLinkID2;
#ifdef CONFIG_RTL865XB_3G
extern int reCore_registerWANDevice(struct net_device* newWanDev);
...
#ifdef CONFIG_RTL865XB_3G
{
			...
			retval=rtl8651_fwdEngineExtPortRecv(skb, skb->data, skb->len,CONFIG_RTL865XB_3G_VLAN, 1<<CONFIG_RTL865XB_3G_PORT, myLinkID2);
			if(retval==0){
...
// for verify Cardbus USB v1.1 throughput
	...
	if(0!=devglue_unregExtDevice(myLinkID2))
