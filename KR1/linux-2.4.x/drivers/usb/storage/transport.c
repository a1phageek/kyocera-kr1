 ...
 *
 * $Id: transport.c,v 1.5 2004/05/31 02:14:34 rupert Exp $
 *
...
static void set_USB_bulk_led(int port, int action)
{
...
int usb_stor_Bulk_transport(Scsi_Cmnd *srb, struct us_data *us)
{
	...
	if (result == 0) {
		...
		{
			//if(us->pusb_dev->physical_port_id != -1)
			//	set_USB_bulk_led(us->pusb_dev->physical_port_id, 0);	
 ...
 out:
	...
	//if(us->pusb_dev->physical_port_id != -1)
	//	set_USB_bulk_led(us->pusb_dev->physical_port_id, 1);	
