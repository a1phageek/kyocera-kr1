/* $Id: xsysace_l.h,v 1.1 2004/05/31 02:26:13 rupert Exp $ */
/******************************************************************************
*
...
int XSysAce_ReadSector(u32 BaseAddress, u32 SectorId,
                       u8 *BufferPtr);
int XSysAce_WriteSector(u32 BaseAddress, u32 SectorId,
                        u8 *BufferPtr);
