/* $Id: xsysace.h,v 1.1 2004/05/31 02:26:13 rupert Exp $ */
/******************************************************************************
*
...
typedef struct
{
    ...
    u16 NumBytesPerTrack;   /**< Number of unformatted bytes per track */
    u16 NumBytesPerSector;  /**< Number of unformatted bytes per sector */
    u16 NumSectorsPerTrack; /**< Default number of sectors per track */
    u32 NumSectorsPerCard;  /**< Default number of sectors per card */
    ...
    u16 TranslationValid;   /**< Translation parameters are valid */
    u16 CurNumCylinders;    /**< Current number of cylinders */
    u16 CurNumHeads;        /**< Current number of heads */
    u16 CurSectorsPerTrack; /**< Current number of sectors per track */
    u32 CurSectorsPerCard;  /**< Current capacity in sectors */
    ...
    u8 VendorUniqueBytes[62]; /**< Vendor unique bytes */
...
XStatus XSysAce_ProgramChain(XSysAce *InstancePtr, u8 *BufferPtr, int NumBytes);
