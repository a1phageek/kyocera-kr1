 ...
 *
 *------------------------------------------------------------------
 * $Header: /home/cvsroot/uClinux-dist/linux-2.4.x/drivers/char/can4linux/can_util.c,v 1.1 2004/05/31 02:32:33 rupert Exp $
 *
 *--------------------------------------------------------------------------
 *
 *
...
volatile unsigned long *imrp;	/* interrupt mask register pointer    */
	...
	26             -- Wake-Up Int                  154
       ...
       (for INTC1)                    
       vector_number = 137 (receive object == MB 1) 
