...
char zft_src[] __initdata = "$Source: /home/cvsroot/uClinux-dist/linux-2.4.x/drivers/char/ftape/zftape/zftape-init.c,v $";
char zft_rev[] __initdata = "$Revision: 1.2 $";
char zft_dat[] __initdata = "$Date: 2004/05/31 02:32:34 $";
