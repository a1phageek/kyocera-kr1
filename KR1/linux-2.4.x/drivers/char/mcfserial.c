 ...
 */
#if defined(CONFIG_ARNEWSH) || defined(CONFIG_MOTOROLA) || defined(CONFIG_COBRA5272) || defined(CONFIG_AVNET) || defined(CONFIG_COBRA5282)
#define	CONSOLE_BAUD_RATE	19200
#define	DEFAULT_CBAUD		B19200
#endif
#if defined(CONFIG_GILBARCONAP) || defined(CONFIG_DNP5280) || defined(CONFIG_SIGNAL_MCP751)
