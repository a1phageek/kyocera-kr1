...
static ssize_t read_chan(struct tty_struct *tty, struct file *file,
			 unsigned char __user *buf, size_t nr) //ed2005
{
	unsigned char __user *b = buf; //ed2005
