...
/* $Id: nsp_cs.c,v 1.2 2004/05/31 02:15:03 rupert Exp $ */
...
MODULE_DESCRIPTION("WorkBit NinjaSCSI-3 / NinjaSCSI-32Bi(16bit) PCMCIA SCSI host adapter module $Revision: 1.2 $");
