...
#define ATH_FF_NEXTSKB_PUT(_skb, _next) ((*(u_int32_t *)(&((_skb)->cb[12]))) = (u_int32_t)(_next) ) 
#define ATH_FF_NEXTSKB_GET(_skb) ( (struct sk_buff *)( (*(u_int32_t *) (&((_skb)->cb[12]))) ) )

/*
 * default value for the minimum txq depth required for an ath_buf to be
 * placed on the FF staging queue.
 */
