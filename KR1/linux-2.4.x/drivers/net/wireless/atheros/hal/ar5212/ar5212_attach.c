 ...
 * All rights reserved.
 *
 * $Id: //depot/sw/releases/SuperG_Linux_AP/src/802_11/madwifi/hal/ar5212/ar5212_attach.c#3 $
 */
#include "opt_ah.h"
...
static const struct ath_hal_private ar5212hal = {{
	...
	.ah_enablePhyErrDiag		= ar5212EnableRadarDetection,
	.ah_disablePhyErrDiag		= ar5212DisableRadarDetection,
	...
	.ah_initPSPoll			= ar5212InitPSPoll,
	.ah_enablePSPoll		= ar5212EnablePSPoll,
	.ah_disablePSPoll		= ar5212DisablePSPoll,
	...
	.ah_enableRadarDetection	= ar5212EnableRadarDetection,
...
#define	N(a)	(sizeof(a)/sizeof(a[0]))
	...
	ahp->ah_micEnabled = AH_TRUE;		/* use h/w MIC by default */
...
ar5212Detach(struct ath_hal *ah)
{
	...
	ar5212SetPowerMode(ah, HAL_PM_FULL_SLEEP, AH_TRUE, 0);
...
#define	IS_GRIFFIN_LITE(ah) \
	...
	pCap->halCipherAesCcmSupport =
		(ahpriv->ah_macRev >= AR_SREV_VERSION_OAHU &&
