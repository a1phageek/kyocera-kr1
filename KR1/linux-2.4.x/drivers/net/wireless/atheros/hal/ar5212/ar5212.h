 ...
 * All rights reserved.
 *
 * $Id: //depot/sw/releases/SuperG_Linux_AP/src/802_11/madwifi/hal/ar5212/ar5212.h#4 $
 */
...
#ifdef AH_USE_RADAR
#define HAL_PROCESS_RADAR	0x00000002	/* Enable Radar detect if needed */
#endif
...
#ifdef AH_USE_RADAR
#define DO_RADAR(ah) \
	((AH5212(ah)->ah_procPhyErr & HAL_PROCESS_RADAR))
#endif
...
struct ath_hal_5212 {
	...
	HAL_BOOL	ah_micEnabled;		/* h/w mic support enabled */
...
extern	void ar5212EnableRadarDetection(struct ath_hal *ah);
extern	void ar5212DisableRadarDetection(struct ath_hal *ah);
...
extern	HAL_BOOL ar5212InitPSPoll(struct ath_hal *ah);
extern	HAL_BOOL ar5212EnablePSPoll(struct ath_hal *, u_int8_t *, u_int16_t);
extern	HAL_BOOL ar5212DisablePSPoll(struct ath_hal *ah);
...
#ifdef AH_USE_RADAR
extern	void ar5212RadarAttach(struct ath_hal *ah);
extern	void ar5212RadarDetach(struct ath_hal *ah);
extern	void ar5212RadarReset(struct ath_hal *ah);
extern	void ar5212RadarEventReport(struct ath_hal *ah, const struct ath_desc *ds);
extern	void ar5212AREventReport(struct ath_hal *ah, const struct ath_desc *ds,
				 u_int8_t *va_buf);
#endif
