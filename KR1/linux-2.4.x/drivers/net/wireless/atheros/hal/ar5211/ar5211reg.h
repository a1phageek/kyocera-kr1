 ...
 * All rights reserved.
 *
 * $Id: //depot/sw/releases/SuperG_Linux_AP/src/802_11/madwifi/hal/ar5211/ar5211reg.h#3 $
 */
...
#define	AR_SCR_SLE_MASK	0x00030000	/* sleep enable mask */
#define	AR_SCR_SLE_SHIFT	16	/* sleep enable bits shift */
