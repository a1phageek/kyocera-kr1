 ...
 * All rights reserved.
 *
 * $Id: //depot/sw/releases/SuperG_Linux_AP/src/802_11/madwifi/hal/ar5211/ar5211.h#3 $
 */
...
extern	void ar5211EnableRadarDetection(struct ath_hal *);
...
extern	HAL_BOOL ar5211InitPSPoll(struct ath_hal *);
extern	HAL_BOOL ar5211EnablePSPoll(struct ath_hal *,
		u_int8_t *bssid, u_int16_t assocId);
extern	HAL_BOOL ar5211DisablePSPoll(struct ath_hal *);
