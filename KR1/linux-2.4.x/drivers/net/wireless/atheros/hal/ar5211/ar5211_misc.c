 ...
 * All rights reserved.
 *
 * $Id: //depot/sw/releases/SuperG_Linux_AP/src/802_11/madwifi/hal/ar5211/ar5211_misc.c#3 $
 */
#include "opt_ah.h"
 ...
 */
void
ar5211EnableRadarDetection(struct ath_hal *ah)
{
	/* Enable pulse detection */
	OS_REG_WRITE(ah, AR_PHY_RADAR_0, AR_PHY_RADAR_0_ENA);
	/* Enable RXPHY interrupt. */
	ar5211SetInterrupts(ah, AH5211(ah)->ah_maskReg | HAL_INT_RXPHY);
}
