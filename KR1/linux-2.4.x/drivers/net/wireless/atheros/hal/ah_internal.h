 ...
 * All rights reserved.
 *
 * $Id: //depot/sw/releases/SuperG_Linux_AP/src/802_11/madwifi/hal/ah_internal.h#3 $
 */
...
typedef struct {
	...
	u_int16_t	channelFlags;	/* as above... */
...
/*
 * Private HAL Capabilities which can be set and read via set/get
 * capabilities
 */

#define HAL_CAP_RADAR		0		/* Support for radar detect */
...
#define	INIT_BEACON_CWMIN	0
#define	INIT_BEACON_AIFS	0
...
/*
 * Return channel's power, in dBm, based on the
 * current regulatory domain.
 */
extern	u_int ath_hal_getchannelpower(struct ath_hal *, HAL_CHANNEL *);
/*
