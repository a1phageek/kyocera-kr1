 ...
 * All rights reserved.
 *
 * $Id: //depot/sw/releases/SuperG_Linux_AP/src/802_11/madwifi/hal/ar5210/ar5210.h#3 $
 */
...
extern	void ar5210EnableRadarDetection(struct ath_hal *);
...
extern	HAL_BOOL ar5210InitPSPoll(struct ath_hal *);
extern	HAL_BOOL ar5210EnablePSPoll(struct ath_hal *,
		u_int8_t *bssid, u_int16_t assocId);
extern	HAL_BOOL ar5210DisablePSPoll(struct ath_hal *);
