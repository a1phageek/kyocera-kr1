 ...
 * All rights reserved.
 *
 * $Id: //depot/sw/releases/SuperG_Linux_AP/src/802_11/madwifi/hal/ah.c#4 $
 */
#include "opt_ah.h"
	...
	HAL_BOOL shortPreamble)
{
	...
	HALASSERT(rateix < rates->rateCount);
	kbps = rates->info[rateix].rateKbps;
	HALASSERT(rates->info[rateix].rateKbps != 0);
