 ...
 * All rights reserved.
 *
 * $Id: //depot/sw/releases/SuperG_Linux_AP/src/802_11/madwifi/hal/ar5312/ar5312_power.c#3 $
 */
#include "opt_ah.h"
 ...
 */
static void
ar5312SetPowerModeNetworkSleep(struct ath_hal *ah, int setChip, u_int16_t sleepDuration)
{
        /* No need for this at the moment for APs */
}
 ...
 */
HAL_BOOL
ar5312SetPowerMode(struct ath_hal *ah, HAL_POWER_MODE mode,
	int setChip, u_int16_t sleepDuration)
{
	...
	case HAL_PM_NETWORK_SLEEP:
		ar5312SetPowerModeNetworkSleep(ah, setChip, sleepDuration);
		break;
	default:
