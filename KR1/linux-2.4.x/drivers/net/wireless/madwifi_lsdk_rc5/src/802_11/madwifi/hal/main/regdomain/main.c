 ...
 * All rights reserved.
 *
 * $Id: //depot/sw/releases/linuxsrc/src/802_11/madwifi/hal/main/regdomain/main.c#3 $
 */
#include "opt_ah.h"
...
enum EnumRd {
	...
	MKK3_MKKA	= 0x80,		/* Japan UNI-1 even + MKKA */
	MKK3_MKKB	= 0x81,		/* Japan UNI-1 even + MKKB */
	MKK3_FCCA	= 0x82,		/* Japan UNI-1 even + FCCA */
	MKK3_MKKA1	= 0x83,		/* Japan UNI-1 even + MKKA1 */
	MKK3_MKKA2	= 0x84,		/* Japan UNI-1 even + MKKA2 */
	MKK3_MKKC	= 0x85,		/* Japan UNI-1 even + MKKC */

	MKK4_MKKA	= 0x86,		/* Japan UNI-1 even + UNI-2 + MKKA */
	MKK4_MKKB	= 0x87,		/* Japan UNI-1 even + UNI-2 + MKKB */
	MKK4_FCCA	= 0x88,		/* Japan UNI-1 even + UNI-2 + FCCA */
	MKK4_MKKA1	= 0x89,		/* Japan UNI-1 even + UNI-2 + MKKA1 */
	MKK4_MKKA2	= 0x8A,		/* Japan UNI-1 even + UNI-2 + MKKA2 */
	MKK4_MKKC	= 0x8B,		/* Japan UNI-1 even + UNI-2 + MKKC */

	MKK5_MKKA	= 0x8C,		/* Japan UNI-1 even + UNI-2 + mid-band */
	MKK5_MKKB	= 0x8D,		/* Japan UNI-1 even + UNI-2 + mid-band + MKKB */
	MKK5_FCCA	= 0x8E,		/* Japan UNI-1 even + UNI-2 + mid-band + FCCA */
	MKK5_MKKA1	= 0x8F,		/* Japan UNI-1 even + UNI-2 + mid-band + MKKA1 */
	MKK5_MKKA2	= 0x90,		/* Japan UNI-1 even + UNI-2 + mid-band + MKKA2 */
	MKK5_MKKC	= 0x91,		/* Japan UNI-1 even + UNI-2 + mid-band + MKKC */

	MKK6_MKKA	= 0x92,		/* Japan UNI-1 even + UNI-1 odd */
	MKK6_MKKB	= 0x93,		/* Japan UNI-1 even + UNI-1 odd MKKB */
	MKK6_FCCA	= 0x94,		/* Japan UNI-1 even + UNI-1 odd + FCCA */
	MKK6_MKKA1	= 0x95,		/* Japan UNI-1 even + UNI-1 odd + MKKA1 */
	MKK6_MKKA2	= 0x96,		/* Japan UNI-1 even + UNI-1 odd + MKKA2 */
	MKK6_MKKC	= 0x97,		/* Japan UNI-1 even + UNI-1 odd + MKKC */

	MKK7_MKKA	= 0x98,		/* Japan UNI-1 even + UNI-1 odd + UNI-2 */
	MKK7_MKKB	= 0x99,		/* Japan UNI-1 even + UNI-1 odd + UNI-2 + MKKB */
	MKK7_FCCA	= 0x9A,		/* Japan UNI-1 even + UNI-1 odd + UNI-2 + FCCA */
	MKK7_MKKA1	= 0x9B,		/* Japan UNI-1 even + UNI-1 odd + UNI-2 + MKKA1 */
	MKK7_MKKA2	= 0x9C,		/* Japan UNI-1 even + UNI-1 odd + UNI-2 + MKKA2 */
	MKK7_MKKC	= 0x9D,		/* Japan UNI-1 even + UNI-1 odd + UNI-2 + MKKC */

	MKK8_MKKA	= 0x9E,		/* Japan UNI-1 even + UNI-1 odd + UNI-2 + mid-band */
	MKK8_MKKB	= 0x9F,		/* Japan UNI-1 even + UNI-1 odd + UNI-2 + mid-band + MKKB */
	MKK8_FCCA	= 0xA0,		/* Japan UNI-1 even + UNI-1 odd + UNI-2 + mid-band + FCCA */
	MKK8_MKKA1	= 0xA1,		/* Japan UNI-1 even + UNI-1 odd + UNI-2 + mid-band + MKKA1 */
	MKK8_MKKA2	= 0xA2,		/* Japan UNI-1 even + UNI-1 odd + UNI-2 + mid-band + MKKA2 */
	MKK8_MKKC	= 0xA3,		/* Japan UNI-1 even + UNI-1 odd + UNI-2 + mid-band + MKKC */

	MKK9_MKKA	= 0xA4,		/* Japan UNI-1 even + 4.9GHz */
	MKK10_MKKA	= 0xA5,		/* Japan UNI-1 even + UNI-2 + 4.9GHz */
	MKK11_MKKA	= 0xA6,		/* Japan UNI-1 even + UNI-2 + mid-band + 4.9GHz */
	MKK12_MKKA	= 0xA7,		/* Japan UNI-1 even + UNI-1 odd + 4.9GHz */
	MKK13_MKKA	= 0xA8,		/* Japan UNI-1 even + UNI-1 odd + UNI-2 + 4.9GHz */
	MKK14_MKKA	= 0xA9,		/* Japan UNI-1 even + UNI-1 odd + UNI-2 + mid-band + 4.9GHz */
	...
	MKK11		= 0x0C40,	/* Japan (UNI-1 even + UNI-2 + mid-band + 4.9GHz) */
	MKK12		= 0x0D40,	/* Japan (UNI-1 even + UNI-1 odd + 4.9GHz) */
	MKK13		= 0x0E40,	/* Japan (UNI-1 even + UNI-1 odd + UNI-2 + 4.9GHz) */
	MKK14		= 0x0F40,	/* Japan (UNI-1 even + UNI-1 odd + UNI-2 + mid-band + 4.9GHz) */
...
static struct {
	...
	{ "MKK3_MKKB",  MKK3_MKKA },
	{ "MKK3_FCCA",  MKK3_FCCA },
	{ "MKK3_MKKA1",  MKK3_MKKA1 },
	{ "MKK3_MKKA2",  MKK3_MKKA2 },
	{ "MKK3_MKKC",  MKK3_MKKC },

	{ "MKK4_MKKA",  MKK4_MKKA },
	{ "MKK4_MKKB",  MKK4_MKKA },
	{ "MKK4_FCCA",  MKK4_FCCA },
	{ "MKK4_MKKA1", MKK4_MKKA1 },
	{ "MKK4_MKKA2", MKK4_MKKA2 },
	{ "MKK4_MKKC",  MKK4_MKKC },
	...
	{ "MKK5_MKKA2", MKK5_MKKA2 },
	{ "MKK5_MKKC",  MKK5_MKKC },

	{ "MKK6_MKKA",  MKK6_MKKA },
	{ "MKK6_MKKB",  MKK6_MKKA },
	{ "MKK6_FCCA",  MKK6_FCCA },
	{ "MKK6_MKKA1", MKK6_MKKA1 },
	{ "MKK6_MKKA2", MKK6_MKKA2 },
	{ "MKK6_MKKC",  MKK6_MKKC },

	{ "MKK7_MKKA",  MKK7_MKKA },
	{ "MKK7_MKKB",  MKK7_MKKA },
	{ "MKK7_FCCA",  MKK7_FCCA },
	{ "MKK7_MKKA1", MKK7_MKKA1 },
	{ "MKK7_MKKA2", MKK7_MKKA2 },
	{ "MKK7_MKKC",  MKK7_MKKC },

	{ "MKK8_MKKA",  MKK8_MKKA },
	{ "MKK8_MKKB",  MKK8_MKKA },
	{ "MKK8_FCCA",  MKK8_FCCA },
	{ "MKK8_MKKA1", MKK8_MKKA1 },
	{ "MKK8_MKKA2", MKK8_MKKA2 },
	{ "MKK8_MKKC",  MKK8_MKKC },


	{ "MKK9_MKKA",   MKK9_MKKA },
	{ "MKK10_MKKA",  MKK10_MKKA },
	{ "MKK11_MKKA",  MKK11_MKKA },
	{ "MKK12_MKKA", MKK12_MKKA },
	{ "MKK13_MKKA", MKK13_MKKA },
	{ "MKK14_MKKA",  MKK14_MKKA },
...
static const COUNTRY_CODE_TO_ENUM_RD allCountries[] = {
    ...
    {CTRY_JAPAN6,      MKK1_MKKC,     "J6", "JAPAN6",     YES, NO,  NO	},    

    {CTRY_JAPAN7,      MKK3_MKKA,     "JP", "JAPAN7",     YES, NO,  NO	 },
    {CTRY_JAPAN8,      MKK3_MKKB,     "J1", "JAPAN8",     YES, NO,  NO	 },
    {CTRY_JAPAN9,      MKK3_FCCA,     "J2", "JAPAN9",     YES, NO,  NO	 },    
    {CTRY_JAPAN10,     MKK3_MKKA1,    "J4", "JAPAN10",   YES, NO,  NO	 },
    {CTRY_JAPAN11,     MKK3_MKKA2,    "J5", "JAPAN11",   YES, NO,  NO	 },    
    {CTRY_JAPAN12,     MKK3_MKKC,     "J6", "JAPAN12",   YES, NO,  NO	 },    

    {CTRY_JAPAN13,     MKK4_MKKA,     "JP", "JAPAN13",   YES, NO,  NO	 },
    {CTRY_JAPAN14,     MKK4_MKKB,     "J1", "JAPAN14",   YES, NO,  NO	 },
    {CTRY_JAPAN15,     MKK4_FCCA,     "J2", "JAPAN15",   YES, NO,  NO	 },    
    {CTRY_JAPAN16,     MKK4_MKKA1,    "J4", "JAPAN16",   YES, NO,  NO	 },
    {CTRY_JAPAN17,     MKK4_MKKA2,    "J5", "JAPAN17",   YES, NO,  NO	 },    
    {CTRY_JAPAN18,     MKK4_MKKC,     "J6", "JAPAN18",   YES, NO,  NO	 },    

    {CTRY_JAPAN19,     MKK5_MKKA,     "JP", "JAPAN19",   YES, NO,  NO	 },
    {CTRY_JAPAN20,     MKK5_MKKB,     "J1", "JAPAN20",   YES, NO,  NO	 },
    {CTRY_JAPAN21,     MKK5_FCCA,     "J2", "JAPAN21",   YES, NO,  NO	 },    
    {CTRY_JAPAN22,     MKK5_MKKA1,    "J4", "JAPAN22",   YES, NO,  NO	 },
    {CTRY_JAPAN23,     MKK5_MKKA2,    "J5", "JAPAN23",   YES, NO,  NO	 },    
    {CTRY_JAPAN24,     MKK5_MKKC,     "J6", "JAPAN24",   YES, NO,  NO	 },    

    {CTRY_JAPAN25,     MKK6_MKKA,     "JP", "JAPAN25",   YES, NO,  NO	 },
    {CTRY_JAPAN26,     MKK6_MKKB,     "J1", "JAPAN26",   YES, NO,  NO	 },
    {CTRY_JAPAN27,     MKK6_FCCA,     "J2", "JAPAN27",   YES, NO,  NO	 },    
    {CTRY_JAPAN28,     MKK6_MKKA1,    "J4", "JAPAN28",   YES, NO,  NO	 },
    {CTRY_JAPAN29,     MKK6_MKKA2,    "J5", "JAPAN29",   YES, NO,  NO	 },    
    {CTRY_JAPAN30,     MKK6_MKKC,     "J6", "JAPAN30",   YES, NO,  NO	 },    

    {CTRY_JAPAN31,     MKK7_MKKA,     "JP", "JAPAN31",   YES, NO,  NO	 },
    {CTRY_JAPAN32,      MKK7_MKKB,     "J1", "JAPAN32",   YES, NO,  NO	 },
    {CTRY_JAPAN33,      MKK7_FCCA,     "J2", "JAPAN33",   YES, NO,  NO	 },    
    {CTRY_JAPAN34,      MKK7_MKKA1,    "J4", "JAPAN34",   YES, NO,  NO	 },
    {CTRY_JAPAN35,      MKK7_MKKA2,    "J5", "JAPAN35",   YES, NO,  NO	 },    
    {CTRY_JAPAN36,      MKK7_MKKC,     "J6", "JAPAN36",   YES, NO,  NO	 },    

    {CTRY_JAPAN37,      MKK8_MKKA,     "JP", "JAPAN37",   YES, NO,  NO	 },
    {CTRY_JAPAN38,      MKK8_MKKB,     "J1", "JAPAN38",   YES, NO,  NO	 },
    {CTRY_JAPAN39,      MKK8_FCCA,     "J2", "JAPAN39",   YES, NO,  NO	 },    
    {CTRY_JAPAN40,      MKK8_MKKA1,    "J4", "JAPAN40",   YES, NO,  NO	 },
    {CTRY_JAPAN41,      MKK8_MKKA2,    "J5", "JAPAN41",   YES, NO,  NO	 },    
    {CTRY_JAPAN42,      MKK8_MKKC,     "J6", "JAPAN42",   YES, NO,  NO	 },    

    {CTRY_JAPAN43,      MKK9_MKKA,     "JP", "JAPAN43",   YES, NO,  NO	 },
    {CTRY_JAPAN44,      MKK10_MKKA,    "J1", "JAPAN44",   YES, NO,  NO	 },
    {CTRY_JAPAN45,      MKK11_MKKA,    "J2", "JAPAN45",   YES, NO,  NO	 },    
    {CTRY_JAPAN46,      MKK12_MKKA,    "J4", "JAPAN46",   YES, NO,  NO	 },
    {CTRY_JAPAN47,      MKK13_MKKA,    "J5", "JAPAN47",   YES, NO,  NO	 },    
    {CTRY_JAPAN48,      MKK14_MKKA,    "J6", "JAPAN48",   YES, NO,  NO	 },    
