 ...
 * All rights reserved.
 *
 * $Id: //depot/sw/releases/linuxsrc/src/802_11/madwifi/hal/main/ar5212/ar5212.h#6 $
 */
...
extern	HAL_BOOL ar5212HaveRadarEvent(struct ath_hal *ah);
extern	HAL_BOOL ar5212ProcessRadarEvent(struct ath_hal *ah, HAL_CHANNEL *chan);
extern	HAL_BOOL ar5212SetRadarThresholds(struct ath_hal *ah,
		const u_int32_t threshType, const u_int32_t value);
extern	HAL_BOOL ar5212GetRadarThresholds(struct ath_hal *ah,
		struct ar5212RadarState *thresh);
extern	u_int32_t ar5212CheckRadarNol(struct ath_hal *ah, HAL_CHANNEL *chans, u_int32_t nchans);
#ifdef AH_PRIVATE_DIAG
