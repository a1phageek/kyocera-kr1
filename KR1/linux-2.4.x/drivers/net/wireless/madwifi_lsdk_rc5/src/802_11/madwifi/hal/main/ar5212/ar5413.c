 ...
 * All rights reserved.
 *
 * $Id: //depot/sw/releases/linuxsrc/src/802_11/madwifi/hal/main/ar5212/ar5413.c#1 $
 * $File: //depot/sw/releases/linuxsrc/src/802_11/madwifi/hal/main/ar5212/ar5413.c $
 * $Author: kcyu $
 * $DateTime: 2005/09/14 18:20:37 $
 * $Change: 149374 $
 *
 */
#include "opt_ah.h"
	...
	u_int16_t *rfXpdGain)
{
	...
	ar5413getGainBoundariesAndPdadcsForPowers(ah, chan->channel,
