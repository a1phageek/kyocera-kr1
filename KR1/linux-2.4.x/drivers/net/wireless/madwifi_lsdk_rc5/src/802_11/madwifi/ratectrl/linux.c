 ...
 * All rights reserved.
 *
 * $Id: //depot/sw/releases/linuxsrc/src/802_11/madwifi/ratectrl/linux.c#8 $
 */
	...
	if (ds->ds_txstat.ts_rate & HAL_TXSTAT_ALTRATE) {
		...
		for (series = 0; series < finalTSIdx; series++) {
			...
			PKTLOG_TX_PKT(NULL, 
				...
				series, ds->ds_txstat.ts_rssi,
				tries, 
				ds->ds_txstat.ts_status,
				(A_UINT16)0,
				(A_UINT16)(ds->ds_txstat.ts_seqnum),
				ds->ds_txstat.ts_antenna,
				(A_UINT16)ds->ds_txstat.ts_tstamp);
