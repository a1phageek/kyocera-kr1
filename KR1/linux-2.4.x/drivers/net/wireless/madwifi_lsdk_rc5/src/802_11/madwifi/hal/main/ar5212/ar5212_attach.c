 ...
 * All rights reserved.
 *
 * $Id: //depot/sw/releases/linuxsrc/src/802_11/madwifi/hal/main/ar5212/ar5212_attach.c#7 $
 */
#include "opt_ah.h"
...
static const struct ath_hal_private ar5212hal = {{
	...
	.ah_radarHaveEvent		= ar5212HaveRadarEvent,
	.ah_processDfs			= ar5212ProcessRadarEvent,
	.ah_dfsNolCheck			= ar5212CheckRadarNol,
	...
	HAL_BUS_TAG st, HAL_BUS_HANDLE sh, HAL_STATUS *status)
{
	...
	ar5212AniAttach(ah);
	/* Setup 5212 Radar/AR structures */
	ecode = ar5212RadarAttach(ah);
	if (ecode  != HAL_OK) {
		goto bad;
	}
