...
*
* -------------------------------------------------------
* $Id: rtl_cle.h,v 1.5 2004/11/10 05:19:55 cfliu Exp $
* $Log: rtl_cle.h,v $
...
//-------------------------------------------------------------
//for execFun use -- if you want to show message to parser result ,
//					 use cle_printf replace printf
//input: userID - give by execution function's first arg 
//-------------------------------------------------------------
#define cle_printf  rtlglue_printf
#define  clePrintf	rtlglue_printf
