...
#if 0
typedef struct rtl8651_tblDrv_protoTrapAsicArrangementEntry_s {
	uint16 trapContent;	//Comparison content
	uint16 trapType:3,	
		   valid:1;
} rtl8651_tblDrvprotoTrapAsicArrangementEnty_t;
#endif
...
#if 0
typedef struct rtl8651_tblDrv_protoTrap_s {
	uint16 trapContent;	//Comparison content
	uint16 trapType:3,	
		   valid:1;
} rtl8651_tblDrv_protoTrap_t;
#endif
#endif /*RTL8650B*/
