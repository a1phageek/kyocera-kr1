...
* Creator : 
* Author :
* $Id: rtl8651_alg_battlenet.h,v 1.4 2004/12/01 13:08:16 tony Exp $
...
int32 rtl8651_l4AliasHandleBattlenetClientOutbound(struct rtl_pktHdr *, struct ip *,struct rtl8651_tblDrv_naptTcpUdpFlowEntry_s *);

void rtl8651_l4AliasBattlenetReInit(void);
