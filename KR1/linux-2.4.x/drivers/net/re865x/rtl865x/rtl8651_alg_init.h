...
* Creator : 
* Author :  
* $Id: rtl8651_alg_init.h,v 1.10 2005/03/01 08:20:34 tony Exp $
...
#define RTL8651_ALG_PPTP                0x0001
#define RTL8651_ALG_IPSEC               0x0002
#define RTL8651_ALG_L2TP                0x0004
#define RTL8651_ALG_FTP                 0x0008
#define RTL8651_ALG_NETMEETING          0x0010
#define RTL8651_ALG_ICQ                 0x0020
#define RTL8651_ALG_YAHOOMSG            0x0040
#define RTL8651_ALG_IRC                 0x0080
#define RTL8651_ALG_DX7                 0x0100
#define RTL8651_ALG_SIP                 0x0200
#define RTL8651_ALG_ICUII                 0x0400
#define RTL8651_ALG_VDOLIVE                 0x0800
#define RTL8651_ALG_QUAKE                 0x1000
#define RTL8651_ALG_CS                 0x2000 //Counter-Strike /Half Life
#define RTL8651_ALG_BATTLENET	 0x4000 // Blizzard Battlenet: StarCraft , Diablo II
#define RTL8651_ALG_REALAUDIO	 0x8000
#define RTL8651_ALG_CUSEEME	 0x010000
#define RTL8651_ALG_PPTP_SERVER	 0x20000000 // special define for PPTP software
#define RTL8651_ALG_IPSEC_SERVER	 0x40000000 // special define for PPTP software
...
#define RTL8651_ALG_MAX_IDX	17 // MAX ALG functions
...
int32 rtl8651_setAlgQosQueueId(uint32 alg_idx,uint32 queueID,uint32 isHigh);
int32 rtl8651a_setAlgQosQueueId(uint32 SessionID,uint32 alg_idx,uint32 queueID,uint32 isHigh);
