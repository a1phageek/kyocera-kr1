...
* $Id: rtl8651_tblDrvFwd.h,v 1.82 2005/04/01 10:41:57 chenyl Exp $
...
#undef _RTL8651_SLOWPATH_NEWARCH	/* enable Realtek's new slow path code */
...
#undef _RTL8651_FWDENG_RETURN_STATISTIC
/*********************************************************************************************************
...
#define FWDENG_L3UNKNOWNPROTO		35	//unknown L3 protocol

/* IP */
#define FWDENG_IP_CANTFRAG			40	//Can't handle IP fragment			
#define FWDENG_IP_WAN2WAN_ROUTING	41	//pkt rcvd from WAN and should be routed to WAN but function disabled by user
...
#define FWDENG_L4_PORTBOUNCING			54  //pkt rcvd from LAN destined to local server's public IP but function disabled.
...
#define FWDENG_DECISION_DROP				136

#define FWDENG_TOTALERRS					137
...
int32 rtl8651_fwdEngineExtPortRecv(void *id, uint8 *data,  uint32 len, uint16 myvid, uint32 myportmask, uint16 linkId);
void rtl8651_fwdEngineTimeUpdate(uint32 secPassed);
...
int32 rtl8651_fwdEngineAddWlanSTA(uint8 *smac,uint16 myvid, uint32 myportmask, uint16 linkId);
...
void rtl8651a_flushTriggerPortRules(uint32);
int rtl8651a_addTriggerPortRule(uint32,uint8,uint16,uint16,uint8,uint16,uint16, ipaddr_t );
void rtl8651_flushTriggerPortRules(void);
int rtl8651_addTriggerPortRule(uint8,uint16,uint16,uint8,uint16,uint16, ipaddr_t );
int32 _rtl8651_checkInusedTriggerPortExtDsidPort(uint32, uint32, uint16);
...
/*********************************************************************************************************
	misc
**********************************************************************************************************/
int32  rtl8651_isdigit(int32);
int32 rtl8651_isspace(int32);
