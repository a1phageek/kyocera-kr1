...
* All rights reserved.
* 
* $Header: /home/cvsroot/uClinux-dist/linux-2.4.x/drivers/net/re865x/rtl865x/asicRegs.h,v 1.17 2005/03/31 16:34:19 yjlou Exp $
*
...
*
* $Log: asicRegs.h,v $
* Revision 1.17  2005/03/31 16:34:19  yjlou
* +: merge GDMA model and driver code to test module system.
*
...
/* Generic DMA */
#define GDMA_BASE (BD01_BASE+0x8000)	/* 0xBD018000 */
#define GDMACR		(GDMA_BASE+0x00)	/* Generic DMA Control Register */
#define GDMASR		(GDMA_BASE+0x04)	/* Generic DMA Status Register */
#define GDMARR		(GDMA_BASE+0x08)	/* Generic DMA Result Register */
#define GDMARR2		(GDMA_BASE+0x0C)	/* Generic DMA Result Register2 */
#define GDMASDR		(GDMA_BASE+0x10)	/* Generic DMA Source Descriptor Ring Register */
#define GDMADDR		(GDMA_BASE+0x14)	/* Generic DMA Destination Descriptor Ring Register */
