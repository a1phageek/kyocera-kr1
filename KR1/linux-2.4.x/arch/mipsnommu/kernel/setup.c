...
unsigned long mips_machgroup = MACH_GROUP_SIMULATOR;
#elif defined(CONFIG_LEXRA)
unsigned long mips_machgroup = MACH_GROUP_LEXRA;
#else
...
{
#if defined(CONFIG_CPU_R3000) && !defined(CONFIG_SIMULATOR)
