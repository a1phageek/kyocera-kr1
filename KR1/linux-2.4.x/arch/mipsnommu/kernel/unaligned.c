...
asmlinkage void do_ade(struct pt_regs *regs)
{
	 ...
	 */
	//printk("Warning! Unaligned address access at 0x%x PC %x  \n",regs->cp0_badvaddr,pc);
...
#if 0  //turn this on if you want to see the call stack
        printk("Check the System.map with the call stack below...\n");
