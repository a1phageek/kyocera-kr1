...
/* FIXME, for new Simulator, zxl */
#ifdef CONFIG_RTL8670		//to be check!!!! mem
#define SDRAM_BASE      0x0
#define SDRAM_SIZE      (8*1024*1024-2048)
...
#ifdef CONFIG_RTL865X		//to be check!!!! mem
#define SDRAM_BASE      0x0
...
/* FIXME, for new Simulator, zxl */
#ifdef CONFIG_SIMULATOR		//to be check!!!! mem
//extern unsigned long _end_kernel;
/*#define SDRAM_BASE	 0x8200000
#define SDRAM_SIZE  (14*1024*1024-1024)		

#define PHYS_OFFSET	0x88200000		//use dram base ((unsigned long) &_end_kernel)
*/

/*#define SDRAM_BASE      0x2000
#define SDRAM_SIZE      (14*1024*1024-1024)
#define PHYS_OFFSET    0x80002000
*/
#define SDRAM_BASE      0x0
#define SDRAM_SIZE      (8*1024*1024-2048)
#define PHYS_OFFSET    0x80000000
...
#if defined(CONFIG_SIMULATOR)||defined(CONFIG_RTL865X)
