...
/* Add system call verification package */
#ifdef CONFIG_RTL865XB_EXP_VERI
#define __NR_veri			(__NR_Linux + 241)
#define __NR_tabparse			(__NR_Linux + 242)
#undef __NR_Linux_syscalls
#define __NR_Linux_syscalls		242
#endif //CONFIG_RTL865XB_EXP_VERI
