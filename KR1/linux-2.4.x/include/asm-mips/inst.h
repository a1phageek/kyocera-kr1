 ...
 */
enum major_op {
	spec_op, bcond_op, j_op, jal_op, /* 3*/
	beq_op, bne_op, blez_op, bgtz_op,/* 7*/
	addi_op, addiu_op, slti_op, sltiu_op,/* 11*/
	andi_op, ori_op, xori_op, lui_op,/* 15*/
	cop0_op, cop1_op, cop2_op, cop1x_op,/* 19*/
	beql_op, bnel_op, blezl_op, bgtzl_op,/* 23*/
	daddi_op, daddiu_op, ldl_op, ldr_op,/* 27*/
	major_1c_op, jalx_op, major_1e_op, major_1f_op,/* 31*/
	lb_op, lh_op, lwl_op, lw_op,/* 35*/
	lbu_op, lhu_op, lwr_op, lwu_op,/* 39*/
	sb_op, sh_op, swl_op, sw_op,/* 43*/
	sdl_op, sdr_op, swr_op, cache_op,/* 47*/
	ll_op, lwc1_op, lwc2_op, pref_op,/* 51*/
	lld_op, ldc1_op, ldc2_op, ld_op,/* 55*/
	sc_op, swc1_op, swc2_op, major_3b_op, /* Opcode 0x3b is unused *//* 59*/
	scd_op, sdc1_op, sdc2_op, sd_op/* 63*/
};
